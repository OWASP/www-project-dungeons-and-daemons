...
When playing with 3–4 players: 1 Short-Seller
When playing with 5–6 players: 2 Short-Sellers
When playing with 7–8 players: 3 Short-Sellers
...
#### Shuffle and divide the threat cards

- All the [threat cards](cards.md) are shuffled and divided amongst the players.
- Each player gets 2 option cards: a "No incident" card and a "Sabotage" card. They will use these during the pillar events to vote on whether they think the event will go smoothly or be sabotaged.

---

## Step 2: Read the Opening Narration Aloud
...
- A **No incident** option card — The pillar goes on without an incident.
- A **Sabotage** option card — The pillar is sabotaged.
...
2. **Discuss who the Short-Sellers might be** — This is the heart of the game. Players should debate who they think is sabotaging the conference and why. Short-Sellers will try to deflect suspicion, while Loyalists will try to identify patterns and inconsistencies.
3. **Use a Character Ability** — If the player has not used their once-per-game ability, they may use it.
4. **Do nothing** — Legitimate choice. Sometimes staying still is the right call.
